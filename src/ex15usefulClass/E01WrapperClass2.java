...
public class E01WrapperClass2 {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 "원"은 숫자가 아니므로   java.lang.NumberFormatException이 발생된다.
		 */
		String money = "120원";
		//System.out.println("120원:"+Integer.parseInt(money));
		
		/*
		 실수형태의 문자열을 실수로 변경할떄는 parseInt()를 사용할 수 없다.
		 위와 똑같은 에러가 발생된다.( parseInt(): 정수형태의 문자열만 정수로 바꿀수 있는 )
		 */
		...
		System.out.println(Character.isLowerCase('가'));//false 영문자가 아님!
