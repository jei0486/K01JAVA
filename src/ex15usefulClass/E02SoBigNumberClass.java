...
public class E02SoBigNumberClass {
	...
	public static void main(String[] args) {
		...
		/*
		 BigInteger
		 	:int형이나 long형으로 표현 할 수 없는 범위의 큰수를 
		 	연산할 때 사용한다. 인자로 전달할 때 반드시 문자열 형태로 기술해야함.
		 */
		//long lngNum = 1000000000000000;//코드작성불가
		BigInteger bigValue1 = new BigInteger("1000000000000000000000000");
		BigInteger bigValue2 = new BigInteger("-99999999999");
		...
		System.out.println("큰수의 뺼셈결과:"+subResult);
