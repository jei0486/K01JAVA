...
class Orange{
	...
	public void showInfo() {
		System.out.println("오렌지당도는 "+sugar+"입니다");
	}
}
//오렌지 전용박스: Orange객체만 저장할수 있는 클래스
class OrangeBox{
	Orange item;//어렌지타입의 매개변수 item
...
public class Ex01GenericBasic {
	...
	public static void main(String[] args) {
		...
		/*
		 상자1은 오렌지 전용박스 이므로 다른과일(즉 객체)을 저장할 수 없다.
		...
		*/
		...
		/*
		 Object를 기반으로 한 FruitBox는 구현에는 편리하지만 코드레벨에서 
		 컴파일 에러가 발생하지 않으므로, 오류를 찾아내기가 훨씬 더 힘들다.
		 따라서 자료형에 안전하지않은 코드가 된다.
		 */
