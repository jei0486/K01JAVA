...
public class Ex03ArrayList2 {
	...
	public static void main(String[] args) {
		...
		//List 계열의 컬렉션 생성시 타입매개변수를 <Student>형으로 선언함.
		//기본 자료형은 사용할 수 없다. 객체만 가능
		...
		//1)과 2)의 반환 값이 다르다 'remove'에 커서 올려볼것
		
		//1)인덱스를 통한 삭제 : 삭제성공시 해당객체가 반환된다.
		System.out.println("삭제된 객체의 이름:"+
				list2.remove(2).name);
		
		//2)인스턴스 참조값을 통한 삭제 : 삭제 성공시 boolean값이 반환된다.
		list2.remove(st1);
