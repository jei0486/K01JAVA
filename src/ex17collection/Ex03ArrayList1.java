...
/*
 Array List : List계열의 컬렉션으로 
 	-데이터의 중복 저장이 허용된다.
 	-데이터의 저장 순서를 보장한다.
 	-데이터에 접근할 때 iterator() 혹은 get()을 이용한다.
 	-Array라는 이름처럼 '배열'의 특성을 갖고있어 인덱스를 통한
 		저장및 접근이 가능하다.
 */
public class Ex03ArrayList1 {
	...
	public static void main(String[] args) {
		...
		list.add("트와이스");
		list.add(3,"워너원");
		//list.add(5,"소방차");//에러발생. 인덱스는 건너뛸수 없다.
		...
		System.out.println("삭제된객체:"+obj);//삭제된객체:트와이스
