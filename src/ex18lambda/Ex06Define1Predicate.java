...
public class Ex06Define1Predicate {
	...
	public static void main(String[] args) {
		/*
	  	...
	  	: 전달된 인자를 대상으로 true,false를 판단할때 사용하는
	  		추상메소드를 정의하고 있다.(생략돼있다고 생각할 것)
		 */
		...
		//asList() : 일반적인 배열을 List컬렉션으로 변경해주는 메소드 ,static
