...
class Computer {
	...
	/*
	 ...
	 불가능하므로 public으로 선언된 메소드를 통해서 간접 호출을 해야한다.
	...
	public void calculateFunc() {//퍼블릭 프로텍티드 둘다 사용가능
//프로텍티드는 상속받은 관계에서만 사용가능
		keyboardTouch();
		calculate();
	}
	/*
...
/*
 컴퓨터를 상속한 노트북 컴퓨터
 	:컴퓨터가 가지고 있는 기본기능에 휴대이용 부분을 확장하여 정의했음
...
/*
 태블릿 노트북 컴퓨터 
 	:컴퓨터의 기본기능,휴대이용에 펜으로 드로잉 할수 있는 기능까지
 	추가된 클래스
 */
