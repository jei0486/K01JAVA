...
/*
  static정적) 타입의 멤버도 상속이 되고, 하위클래스에서
  접근할때는 멤버변수의 이름만으로 접근이 가능하다.
  단,클래스 외부에서 접근시 객체생성없이 클래스명을 통해서도 접근이 가능함.
  즉  static 이 가진 기본적인 규칙을 그대로 따른다.
 */

class Adder {
	public static int val = 0;
	/*
	 static으로 선언된 멤버변수는 실제로 외부(메소드영역)에 
